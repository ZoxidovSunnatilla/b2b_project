            ...
            <div className="container mx-auto w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 w-full md:gap-5 gap-3 h-auto mb-8 md:h-96 md:mb-24">
                    ...
                    <div className="md:w-auto w-full rounded-lg bg-costum-blue h-full md:px-24 px-6 py-10 md:py-28">
                        <p className="text-white font-bold mb-5 text-3xl">Buy this bundle and save 100K!</p>
                        <p className="text-white text-base mb-7 font-normal text-xl">Longer sentence, for just two lines <br /> and it could be very very long</p>
