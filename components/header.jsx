    ...
    <div className="  ">
          ...
          <div className="w-auto flex relative space-between gap-3 ">
            ...
            <div className="flex relative gap-2 items-center">
              <div className="relative">
                ...
                <div className="bg-costum-orange w-auto absolute rounded-full w-5 h-5 justify-center flex items-center -top-3 -right-2.5 text-xs text-white text-costum-text-black font-normal">
                  12
                </div>
              </div>
              <a
      ...
      <div className="container mx-auto py-5 md:hidden flex justify-between">
        ...
        <div className="relative">
          ...
          <div className="bg-costum-orange w-auto absolute rounded-full w-4 h-4 justify-center flex items-center -top-1.5 right-1 text-xs text-white  text-costum-text-black font-normal">
            12
          </div>
        </div>
      </div>
