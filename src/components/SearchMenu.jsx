...
const SearchMenu = () => {
    return (
        <div className="">
            <div id="menu" className={`min-h-7 md:block hidden left-0 relative   py-12 z-50 fixed w-full shadow-gray-500   shadow-lg shadow-black-500/50   bg-white `}>
                <div className="container mx-auto flex justify-between">
                    ...
                    <div className="w-[408px] pr-5 h-96 scroll-smoth overflow-y-auto">
