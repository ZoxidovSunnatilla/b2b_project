    ...
    <div className="container mx-auto">
        ...
        <div className="flex  gap-5">
          <div className="md:w-1/5 md:block hidden" id="filter">
            <div className="py-10 px-6 bg-costum-gray mb-6">
              <p className="text-2xl text-costum-text-black mb-2">
                {t("listing:listingSubcategoryText")}
              </p>
              <p className="text-sm font-semibold mb-4">
                {t("listing:listingSubcategoryOneTwoText")}{" "}
                <span className="text-costum-blue">
                  {t("listing:listingSubcategoryTwoTwoText")}
                </span>
              </p>
              ...
              <div className="flex justify-between mb-2">
                <div className="flex gap-2 items-center">
                  <Checkbox defaultChecked />
                  <p className="text-costum-text-black">
                    {t("listing:subcategoryThreeText")}
                  </p>
                </div>
                <p className="text-costum-silver text-right">139</p>
              </div>
            ...
            <div className="py-10 px-6 bg-costum-gray">
              <p className="text-2xl font-bold text-costumBlack">
                {t("listing:listingFiltersText")}
              </p>
              <p className="text-costum-blue my-3 font-medium">
                {t("listing:listingClearText")}
              </p>
                  ...
                  <Accordion.Panel>
                    ...
                    <div className="flex justify-between mb-2">
                      <div className="flex gap-2 items-center">
                        <Checkbox />
                        <p className="text-costum-text-black">
                          {t("listing:filterFiveText")}
                        </p>
                      </div>
                      <p className="text-costum-silver text-right">139</p>
                    </div>

                    <a href="" className="text-costum-blue font-semibold">
                      {t("listing:filterShowMoreText")}
                    </a>
                  </Accordion.Panel>
                </Accordion.Item>
                <Accordion.Item value="1_2">
                  ...
                  <Accordion.Panel>
                    <div className="flex justify-between items-center mb-4">
                      <input
                        className=" block bg-white w-2/5 border pl-3  rounded-md h-12  shadow-sm focus:outline-none sm:text-sm"
                  ...
                  <Accordion.Panel>
                    <div className="flex justify-between mb-2">
                      <div className="flex gap-2 items-center">
                        <Checkbox />
                        <p className="text-costum-text-black">
                          {t("listing:filterTwoSubcategoryTextOne")}
                        </p>
                      </div>
                      <p className="text-costum-silver text-right">139</p>
                    </div>
                    <div className="flex justify-between mb-2">
                      <div className="flex gap-2 items-center">
                        <Checkbox />
                        <p className="text-costum-text-black">
                          {t("listing:filterTwoSubcategoryTextTwo")}
                        </p>
                      </div>
                      <p className="text-costum-silver text-right">139</p>
                    </div>
                    <div className="flex justify-between mb-2">
                      <div className="flex gap-2 items-center">
                        <Checkbox />
                        <p className="text-costum-text-black">
                          {t("listing:filterTwoSubcategoryTextThree")}
                        </p>
                      </div>
                      <p className="text-costum-silver text-right">139</p>
                    </div>
                    <div className="flex justify-between mb-2">
                      <div className="flex gap-2 items-center">
                        <Checkbox />
                        <p className="text-costum-text-black">
                          {t("listing:filterTwoSubcategoryTextFour")}
                        </p>
                      </div>
                      <p className="text-costum-silver text-right">139</p>
                    </div>
                    <div className="flex justify-between mb-2">
                      <div className="flex gap-2 items-center">
                        <Checkbox />
                        <p className="text-costum-text-black">
                          {t("listing:filterTwoSubcategoryTextFive")}
                        </p>
                      </div>
                      <p className="text-costum-silver text-right">139</p>
                    </div>
                  ...
                  <Accordion.Panel>
                    ...
                    <div className="flex justify-between mb-2">
                      <div className="flex gap-2 items-center">
                        <Checkbox />
                        <p className="text-costum-text-black">
                          {t("listing:filterThreeSubcategoryTextOne")}
                        </p>
                      </div>
                      <p className="text-costum-silver text-right">139</p>
                    </div>
                    <div className="flex justify-between mb-2">
                      <div className="flex gap-2 items-center">
                        <Checkbox />
                        <p className="text-costum-text-black">
                          {t("listing:filterThreeSubcategoryTextTwo")}
                        </p>
                      </div>
                      <p className="text-costum-silver text-right">139</p>
                    </div>
                    <div className="flex justify-between mb-2">
                      <div className="flex gap-2 items-center">
                        <Checkbox />
                        <p className="text-costum-text-black">
                          {t("listing:filterThreeSubcategoryTextThree")}
                        </p>
                      </div>
                      <p className="text-costum-silver text-right">139</p>
                    </div>
                    <div className="flex justify-between mb-2">
                      <div className="flex gap-2 items-center">
                        <Checkbox />
                        <p className="text-costum-text-black">
                          {t("listing:filterThreeSubcategoryTextFour")}
                        </p>
                      </div>
                      <p className="text-costum-silver text-right">139</p>
                    </div>
          ...
          <div className="md:w-4/5 w-full">
            <p className="text-4xl text-costum-text-black font-bold mb-4">
              {t("listing:listigtTitleText")}
            </p>
            <p className=" mb-10 md:mb-16">
              {t("listing:listingSubTitleText")}
            </p>
              ...
              <div className=" flex md:justify-between justify-center flex-col md:flex-row flex-wrap items-center">
                <div className="flex gap-4 items-center flex-col md:flex-row flex-wrap items-center justify-center">
                  ...
                  <p className="text-white text-center text-4xl mb-4 md:mb-0 md:text-5xl">
                    {t("listing:listingBannerText")}
                  </p>
                </div>
                <button className="text-costum-blue text-base h-12 w-40 bg-white rounded-3xl">
                  {t("listing:listingBannerBtnText")}
                </button>
              </div>
            </div>
            <button
              className="flex md:hidden uppercase text-costum-blue w-full h-12 border border-solid border-costum-blue rounded-md justify-center items-center mb-4"
              onClick={open}
            >
              Filters
            </button>
                    ...
                    <div className="w-full min-h-16 py-2 px-2 rounded-b-lg border-t-0 border border-costum-gray border-solid">
                      ...
                      <div className="md:flex block w-full md:items-center gap-2 mb-3">
                        <p className="text-costum-blue font-bold text-sm md:text-base">
                          your price{" "}
                          <span className="text-2xl mx-1 font-bold">
                            $45.00
                          </span>
                          net
                        </p>
                      ...
                      <div className="flex mb-2 gap-5 w-full  justify-between">
                        <input
                          type="text"
                          name="number"
                          className=" px-3 py-2 h-12 text-center bg-white border shadow-sm border-slate-300 placeholder-slate-400 outline-none w-1/4 md:w-24 block  rounded-md sm:text-sm "
                          placeholder="1"
                        />
                    ...
                    <div className="border-r border-b border-costum-gray-100 border-solid flex">
                      <div className="relative">
                        <Image
                          ...
                          className="w-full"
                        />
                        <div className="absolute top-5 left-0 bg-costum-orange p-1 text-sm   text-white font-bold">
                          -30%
                        </div>
                        <div className="w-8 h-8 rounded-full flex justify-center items-center bg-star absolute top-2 right-2">
                          <Image src="/images/star.svg" alt="" />
                      ...
                      <div className="texts mx-5">
                        <p className="text-sm text-costum-silver mb-2.5 mt-3.5">
                          Logo Brand Name | Part No. 234565
                        </p>
                        <p className="text-xl font-bold  mb-3">
                          Ledsystems P45 LED, milky, warm color
                        </p>
                        <p className="text-sm mb-1">
                          Bulb thread type:{" "}
                          <span className="font-semibold">E27</span>
                        </p>
                        <p className="text-sm mb-1">
                          Maximum bulb power:{" "}
                          <span className="font-semibold">E27</span>
                    ...
                    <div className="mx-5 w-3/4 ">
                      ...
                      <div className="flex mb-2 w-full  justify-between">
                        <input
                          type="text"
                          name="number"
                          className=" px-3 py-2 h-12 text-center bg-white border shadow-sm border-slate-300 placeholder-slate-400 outline-none w-12 md:w-24 block  rounded-md sm:text-sm "
                          placeholder="1"
                        />
      ...
      <Drawer opened={opened} onClose={close}>
        <div className="px-4" id="drawer">
          ...
          <p className="text-xl font-bold text-costumBlack">
            Filter & Subcategoris
          </p>
