        ...
        <div>
            <div className='container mx-auto'>
                <Breadcrumbs className='mt-8 mb-10 breadcumbs' >
                    <a href="" className="text-costum-silver text-sm">Link 1</a>
                ...
                <div className="w-full flex gap-5 mb-[50px] md:block hidden" id="account">
                    <Tabs color="gray" className='' variant="pills" radius="xs" orientation="vertical" defaultValue="order">
                        <Tabs.List>
                            ...
                            <div className="siderbar w-[408px] py-10 px-4 rounded-lg bg-[#F6F8FB]">
                                ...
                                <Tabs.Tab value="most">
                                    <p className="text-xl text-[#0C0C0C] mb-4">Most Frequently Bought</p>
                                </Tabs.Tab>
                                <Tabs.Tab value="returns">
                                    <p className="text-xl text-[#0C0C0C] ">Returns and Complaints</p>
                                </Tabs.Tab>
                                <div className=" h-0.5 bg-[#CFD2D5] w-full my-10"></div>
                                ...
                                <Tabs.Tab value="shipping">
                                    <p className="text-xl text-[#0C0C0C] mb-4">Shipping Addresses</p>
                                </Tabs.Tab>
                                <Tabs.Tab value="credit">
                                    <p className="text-xl text-[#0C0C0C] mb-4">Store Credit</p>
                                </Tabs.Tab>
                                <Tabs.Tab value="roles">
                                    <p className="text-xl text-[#0C0C0C] mb-4">Roles and Permissions</p>
                                </Tabs.Tab>
                                <Tabs.Tab value="users">
                                    <p className="text-xl text-[#0C0C0C] mb-4">Users</p>
                                </Tabs.Tab>
                                <Tabs.Tab value="privacy">
                                    <p className="text-xl text-[#0C0C0C] ">Subscriptions and Privacy</p>
                                </Tabs.Tab>
                            </div>
                        </Tabs.List>
