...
import { Breadcrumbs, Tabs, List, Checkbox, Input, Accordion, Rating } from '@mantine/core';
    ...
    <div>
      <div className='container mx-auto mb-20'>
        ...
        <div id="card" className='mb-20'>
          <p className="text-2xl md:text-3xl font-bold text-costum-text-black mb-10">Frequently bought together</p>
              ...
              <div className="w-full md:w-2/3 flex  gap-2">
                <div className="w-auto h-auto  md:min-h-72 bg-white rounded-lg">
                  ...
                  <div className="w-full min-h-16 py-2 px-2 rounded-b-lg border-t-0 border border-costum-gray border-solid">
                    <p className="md:text-xl text-base text-costum-text-black font-bold mb-3.5">AMBER DECOR Small Lamp 60W, E27 590</p>
                  </div>
                </div>
                <div className="w-auto h-auto md:min-h-72 bg-white rounded-lg">
                  <div className="relative">
                  ...
                  <p className="text-silver text-sm md:text-base pt-2 px-2">Omnires | Part No. 2123532</p>
                  <div className="w-full min-h-16 py-2 px-2 rounded-b-lg border-t-0 border border-costum-gray border-solid">
                    <p className="md:text-xl text-base  text-costum-text-black font-bold ">AMBER DECOR Small Lamp 60W, E27 590</p>
                  </div>
                </div>
              </div>
        ...
        <div id="tabs_mobile">
          <Accordion defaultValue='Apple' className='mb-5 md:hidden block'>
            ...
            <Accordion.Item value='1_3'>
              <Accordion.Control>
                <p className="text-sm text-costum-text-black font-normal ml-2 bg-transparent outline-none">Attachments</p>
              </Accordion.Control>
              <Accordion.Panel>
                <div className="bg-star w-full p-2">
                  <div className="w-full p-4 md:p-8 bg-white rounded-lg">
            ...
            <Accordion.Item value='1_4'>
              <Accordion.Control>
                <p className="text-sm text-costum-text-black font-normal ml-2 bg-transparent outline-none">Shipping & Payments</p>
              </Accordion.Control>
              <Accordion.Panel>
                <div className="bg-star w-full p-2">
            ...
            <Accordion.Item value='1_5'>
              <Accordion.Control>
                <p className="text-sm text-costum-text-black font-normal ml-2 bg-transparent outline-none">Reviews (18)</p>
              </Accordion.Control>
              <Accordion.Panel>
                <div className="bg-star w-full p-2">
                  <div className="flex justify-between flex-wrap">
                    ...
                    <div className="w-full md:w-2/5">
                      <p className="text-costum-text-black font-bold text-2xl mb-3">Rate us</p>
                      <div className="flex gap-1 items-center mb-3">
                      <Rating defaultValue={2} />
                        <p className="text-sm font-bold">5.0</p>
                      </div>
            ...
            <Accordion.Item value='1_6'>
              <Accordion.Control>
                <p className="text-sm text-costum-text-black font-normal ml-2 bg-transparent outline-none">Ask about product</p>
              </Accordion.Control>
              <Accordion.Panel>
                <div className="bg-star w-full p-2">
                  <div className="w-full p-3 md:p-8 bg-white rounded-lg"></div>
      ...
      <div id="gift" className="bg-costum-blue py-8 mb-20"  >
        <div className="container mx-auto flex-wrap flex gap-4 ">
          <div className="flex flex-wrap w-full justify-center md:jusctify-start md:w-2/4">
            ...
            <div className="block mt-3 md:mt-0 md:ml-16">
              <p className="text-2xl md:text-4xl text-center md:text-left text-white font-bold mb-3">Enjoy 10% OFF</p>
              <p className="text-sm text-center md:text-left text-white">Stay informed about the latest product launches and <br /> news. Learn more about our emails and </p>
            </div>
          </div>
          <div className="flex items-center gap-5">
            <Input placeholder="Enter your email" radius="md" />
            <button className="bg-white text-costum-blue font-medium h-12 rounded-3xl w-32 md:w-48">Sign Up</button>
          </div>
        </div>
      </div>
